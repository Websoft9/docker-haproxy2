...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r haproxy
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r haproxy -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-haproxy
cd docker-haproxy
docker-compose -f docker-compose.yml  --env-file  .env_all up -d
```
...
#### Why haproxy container error for the reason that need configuration file?  
You should add your haproxy.cfg file at haproxy volume  

### Usage instructions

You can point your browser to: *`http://Instance's Internet IP:8080`*  
...
| --- | --- | --- | --- |
| haproxy | 8080 | HAProxy port | Y |
## Documentation

[HAProxy Administrator Guide](https://support.websoft9.com/docs/haproxy)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [HAProxy Enterprise Support](https://apps.websoft9.com/haproxy) 
